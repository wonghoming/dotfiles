    ...
    return class extends debugSessionClass {
        ...
        attachRequest(request) {
            ...
            return telemetryHelper_1.TelemetryHelper.generate("attach", extProps, (generator) => {
                return Q({})
                    .then(() => {
                    vscode_chrome_debug_core_1.logger.log(localize(1, null));
                    ...
                    this.appWorker.on("connected", (port) => {
                        vscode_chrome_debug_core_1.logger.log(localize(2, null, port));
         ...
         */
        bailOut(message) {
            vscode_chrome_debug_core_1.logger.error(localize(3, null, message));
